...
module.exports.generateResponseObject = function generateResponseObject(requestStatus, referenceNumber, errorCode, errorMessage, errors, data, unexpectedErrorCode) {
    return new Promise((resolve, reject) => {
        try {
            let response = { referenceNumber: uuid(), correlationId: referenceNumber };
 ...
 */
module.exports.syncOriAndTmp = function syncOriAndTmp(referenceNumber, rawProperties, obj, action, unexpectedErrorCode, status) {
    return new Promise((resolve, reject) => {
        try {
